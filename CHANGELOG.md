...
- Historical root/default Task Boards and cumulative handoffs are recovery/provenance input only for the migrated fixed policies; live historical obligations migrate deterministically to an exact branch-isolated workstream before further mutation.
