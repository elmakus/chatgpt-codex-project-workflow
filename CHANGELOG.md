...
- The active brainstorming record persists `Definition promotion authorization: pending | user_authorized` so a fresh chat does not infer phase authority from stale conversation.
