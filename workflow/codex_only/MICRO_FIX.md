...
2. the manifest-selected workstream Task Board from `workflow/codex_only/WORKSTREAM_TASK_BOARD_TEMPLATE.yaml`;
...
implementation_owner_role: null
review:
...
A fresh coordinating context targeting the same micro-fix branch recovers:
...
This module now includes the M04 worktree-isolation, stacked-integration and target-refresh/final-review contract through `WORKSTREAMS.md` and `CLOSE.md`. M05 remains responsible for final end-to-end regression, architecture audit and publication readiness.
